$(document).ready(function() {
  ...
  // var domain = 'www.cleaneats.nyc';
  // var domain = 'seamless-health-grades.herokuapp.com';
  var domain = 'localhost:3000';

  var gradeNotAvailableLink = "<a href='http://" + domain + "/health_inspections/'" +
  ...
  if (document.URL.match(/food-delivery\/home/)) {
    $('#HeaderContainer').bind('DOMSubtreeModified', function() {
      ...
      if (currentContainerSize !== containerSize && currentContainerSize > 0) {
        ...
        setTimeout(function() {
          $.ajax({
            url: 'http://' + domain + '/recently_ordered',
    ...
    $('#HeaderContainer').bind('DOMSubtreeModified', function() {
      ...
      if (currentContainerSize !== containerSize && currentContainerSize > 0) {
        ...
        $.ajax({
          url: 'http://' + domain + '/health_inspections',
